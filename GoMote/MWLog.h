...
#ifdef DEBUG
#define MWLog(format...)					MWDebug(__FILE__, __LINE__, [self class], format)
#else
...
extern void MWDebug(const char *fileName, int lineNumber, Class class, NSString *format, ...);
extern void MWDebugClassFilter(BOOL);
extern void MWDebugAddClass(Class);
extern void MWDebugRemoveClass(Class);
